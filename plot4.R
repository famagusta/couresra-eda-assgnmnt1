...
with(hhd_pow_consm_data_feb2012, {
  ...
  plot(x = as.POSIXct(DATE2),
       ...
       xlab="", main="")
  lines(x = as.POSIXct(DATE2),
        y=as.numeric(Sub_metering_2),col="red")
  lines(x = as.POSIXct(DATE2),
        y=as.numeric(Sub_metering_3),col="blue")
  legend("topright",lty= 1, col=c("black", "red", "blue"),
         bty="n", xjust=1, yjust =1, cex=0.35,
...
dev.copy(png, file = "plot4.png",width=480, height=480, units="p") ## Copy my plot to a PNG file
dev.off()
