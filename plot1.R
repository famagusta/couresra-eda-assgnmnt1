...
with(hhd_pow_consm_data_feb2012, hist(x=as.numeric(Global_active_power),breaks=20,
                    col='red', xlab="Global Active Power (kilowatts)",
                    main="Global Active Power")) ## Create plot on screen device
dev.copy(png, file = "plot1.png",width=480, height=480, units="p") ## Copy my plot to a PNG file
dev.off()
